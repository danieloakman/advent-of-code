 ...
 * @returns {import("iterare/lib/iterate").IteratorWithOperators<RegExpExecArray>}
 */
 ...
 * @returns {import("iterare/lib/iterate").IteratorWithOperators<string>}
 */
 ...
 * @param {boolean} canOverlap 
 * @returns {import("iterare/lib/iterate").IteratorWithOperators<T[]>}
 */
...
/**
 * @param {number} n 
 * @returns {import('iterare/lib/iterate').IteratorWithOperators<number>}
 */
...
module.exports.isInDebug = function () {
  // eslint-disable-next-line node/no-unsupported-features/node-builtins
  return typeof require('inspector').url() !== 'undefined';
};

module.exports.question = async function (questionStr, defaultAnswer = undefined) {
  return new Promise(resolve => {
    if (module.exports.isInDebug())
