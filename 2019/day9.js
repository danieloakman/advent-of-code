...
function intCodeProcess (integers, inputs = [1]) {
  ...
  const value = (i, mode) => {
    ...
    switch (mode) {
      case 1: v = i; break;
      case 2: v = bigArr.get(i + relativeBase); break;
      case 0: // fallthrough
      default: v = bigArr.get(i); break;
    }
...
equals(intCodeProcess([109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99], []).outputs, [109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99]);
